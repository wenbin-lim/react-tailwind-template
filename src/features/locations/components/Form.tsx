...
const Form = ({ type }: FormProps) => {
  ...
  const { data: fetchedData } = useGetOneLocation(id || "");
  ...
  // mutation
  const addFn = useAddOneLocation();
  const updateFn = useUpdateOneLocation(id || "");

  const onSubmit = (newData: Location) => {
