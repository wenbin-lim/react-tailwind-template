        ...
        <div className="grid w-full grid-cols-2 justify-stretch gap-2">
          <button
            ...
            className=" flex h-10 items-center
                       justify-center rounded-full border-2 border-[rgb(var(--vcard-primary-color))] bg-[rgb(var(--vcard-primary-color))]"
          >
            <DownloadSVG
          ...
          <button
            ...
            className="flex h-10
                       items-center justify-center rounded-full border-2 border-[rgb(var(--vcard-primary-color))]"
          >
            <PhoneSVG
              className="text-[rgb(var(--vcard-primary-color))]"
              height="25px"
            />
          </button>
        </div>
