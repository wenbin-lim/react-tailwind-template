...
import {
  ReservationSchema,
  Reservation,
  useGetOneReservation,
  useAddOneReservation,
  useUpdateOneReservation,
} from "../data";
...
const Form = ({ type }: FormProps) => {
  ...
  const { data: fetchedData } = useGetOneReservation(id || "");
  ...
  // mutation
  const addFn = useAddOneReservation();
  const updateFn = useUpdateOneReservation(id || "");

  const onSubmit = (newData: Reservation) => {
